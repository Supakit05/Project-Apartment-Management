              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
                    {/* 1. ROOM RENT */}
                    <div className="p-3.5 rounded-xl bg-white dark:bg-nike-dark-card/60 border border-slate-200/80 dark:border-slate-800 space-y-1">
                      ...
                      <span className="text-[11px] text-slate-400 block">
                        {language === 'th' ? '1 เดือนเต็ม' : '1 Month'}
                      </span>
                    </div>
                    ...
                    <div className="p-3.5 rounded-xl bg-blue-50/50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 space-y-1">
                      <span className="text-blue-700 dark:text-blue-300 font-medium flex items-center gap-1">
                        <Droplets className="w-3.5 h-3.5" /> {language === 'th' ? 'ค่าน้ำประปา' : 'Water Supply'}
                      </span>
                    ...
                    {/* 3. ELECTRICITY */}
                    <div className="p-3.5 rounded-xl bg-amber-50/50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30 space-y-1">
                      <span className="text-amber-700 dark:text-amber-300 font-medium flex items-center gap-1">
                        <Zap className="w-3.5 h-3.5" /> {language === 'th' ? 'ค่าไฟฟ้า' : 'Electricity Supply'}
                      </span>
                      <span className="text-base font-extrabold text-amber-600 dark:text-amber-400 block">
                    ...
                    <div>
                      {isPaid ? (
                        <button
                          ...
                          className="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs flex items-center gap-2 shadow-xs transition-all cursor-pointer active:scale-95"
                        >
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-semibold text-amber-700 dark:text-amber-300 bg-amber-100 dark:bg-amber-950/60 px-3.5 py-2 rounded-xl border border-amber-200 dark:border-amber-800">
